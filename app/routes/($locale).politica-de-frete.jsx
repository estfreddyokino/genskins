    ...
    <div className="max-w-6xl mx-auto py-20 px-6 text-[#0047FF]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h2 className="text-2xl font-semibold mb-4"  style={{marginLeft: '20px', marginBottom: '10px' }}>Para onde enviamos</h2>
        ...
        <div>
          ...
          <h2 className="text-2xl font-semibold mb-4">Custos de envio</h2>
